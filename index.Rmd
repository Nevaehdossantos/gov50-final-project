...
Similar to the previous regression, the statistically significance of the data suggests there is some level of causality but I would not say with complete certainty that there is definite causality between these variables.  There can still be possibility of confounding variables like political and social events that happened around the election, the specific candidate and much more. 
